document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        function validateField(field) {
            ...
            } else if (field.tagName === 'TEXTAREA' && field.required && !value) {
                isValid = false;
                errorMessage = 'This field is required';
            }
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (field && (field.required || field.type === 'email' || field.type === 'tel')) {
                validateField(field);
            }
        });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'bf244867-fdfc-492a-9f16-494fc4343666',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'bf244867-fdfc-492a-9f16-494fc4343666';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'bf244867-fdfc-492a-9f16-494fc4343666';
